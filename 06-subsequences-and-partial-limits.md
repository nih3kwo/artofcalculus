...
1. Для любой подпоследовательности $\{b_n\} \subseteq \{a_n\}$, 
$$
...
:::{prf:proof}
:class: dropdown
:nonumber:[Доказательство теоремы.] Имеем $M_n : = \sup\{a_{n+1}, \ldots, \}$, $M_{n+1}:=\sup \{a_{n+2}, \ldots,\}$ и так как
$$
\{a_n, a_{n+1}, \ldots, \} \supseteq \{a_{n+1}, a_{n+2} \ldots, \},
$$
то по [](#A<B=sup(A)<sup(B)) $M_n \le M_{n+1}$, т. е. последовательность $\{M_n\}$ не возрастает и также $m_n \ge m_{n+1}$, т. е. последовательность $\{m_n\}$ не убывает.
